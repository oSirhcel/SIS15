    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View className='px-4 py-6'>
        <View className='mb-6 items-center'>
          <Text className='text-3xl font-bold text-sky-600'>Scan</Text>
        ...
        <View className='mb-6 rounded-xl bg-white p-6 shadow-sm'>
          <View className='flex-row items-center justify-between'>
            <View className='flex-row items-center'>
              <WalletIcon size={24} className='text-sky-600' />
              <Text className='ml-2 text-lg font-semibold text-sky-600'>
                Your EcoPoints
              </Text>
            </View>
        ...
        <TouchableOpacity
          className='mb-6 flex-row items-center justify-center rounded-lg bg-sky-600 py-4'
